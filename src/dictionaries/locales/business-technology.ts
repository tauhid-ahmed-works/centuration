export const technologyEn = {
  text: {
    ...
    production_automation: "Production & Automation",
    call_buttons: "Call buttons",
    staff_pagers: "Staff Pagers",
    "displays receivers": "Displays receivers",
    signal_lamps: "Signal lamps",
...
export const technologyFr = {
  text: {
    medicine: "Médecine",
    restaurants_services: "Restaurants & Services",
    production_automation: "Production & Automatisation",
    call_buttons: "Boutons d'appel",
    staff_pagers: "Pagers pour le personnel",
    "displays receivers": "Récepteurs d'affichage",
    signal_lamps: "Lampes de signalisation",
