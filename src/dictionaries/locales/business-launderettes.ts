export const launderettesEn = {
  text: {
    chap_chap_point: "FIND A CHAP-CHAP POINT",
    laundry: "laundry",
    dryer: "sèche",
    step: "step",
  },
  ...
  success_story: {
    title: "Success Story",
    subtitle: "Revolution And it's cheaper.",
    description:
  ...
  mobile_experience: {
    ...
    subtitle:
      "Your laundry collected, washed, dried and delivered with the Chap-Chap Laundry App",
    description:
...
export const launderettesFr = {
  text: {
    chap_chap_point: "TROUVER UN POINT CHAP-CHAP",
  ...
  success_story: {
    ...
    subtitle: "Révolution et c’est moins cher.",
    description:
  ...
  mobile_experience: {
    ...
    subtitle:
      "Votre linge collecté, lavé, séché et livré avec l'application Chap-Chap Laundry",
    description:
  ...
  partners: {
    ...
    content:
      "Présents dans plus de 20 pays avec des partenariats de renommée mondiale.",
  },
};
