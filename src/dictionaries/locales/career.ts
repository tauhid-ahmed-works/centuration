export const careerEn = {
  ...
  motivation: {
    ...
    description:
      "At Centurion Group, we foster a culture of innovation, teamwork, and continuous learning. We take pride in developing solutions that make a real difference in people’s lives. Our commitment to excellence means that every team member has the opportunity to contribute meaningfully and grow within a dynamic, purpose-driven organization.",
  },
  benefit: {
    title: "More than just a career",
    description:
      "At Centurion Group, we believe in empowering our employees with the tools, knowledge, and opportunities to grow. We foster an environment where innovation thrives, collaboration is encouraged, and every team member has a chance to make a real impact.",
    additional: ["Flexible Work", "Yearly Tour", "Free Holiday"],
  },
  qna: [
    {
...
export const careerFr = {
  ...
  motivation: {
    ...
    description:
      "Chez Centurion Group, nous favorisons une culture d'innovation, de travail d'équipe et d'apprentissage continu. Nous sommes fiers de développer des solutions qui ont un impact réel sur la vie des gens. Notre engagement envers l'excellence signifie que chaque membre de l'équipe a l'opportunité de contribuer de manière significative et de progresser dans un environnement dynamique et axé sur un objectif.",
  },
  benefit: {
    title: "Bien plus qu'une carrière",
    description:
      "Chez Centurion Group, nous croyons en l'autonomisation de nos employés en leur fournissant les outils, les connaissances et les opportunités nécessaires pour évoluer. Nous favorisons un environnement où l'innovation prospère, où la collaboration est encouragée et où chaque membre de l'équipe a la possibilité d'avoir un réel impact.",
    additional: ["Travail flexible", "Voyage annuel", "Vacances gratuites"],
  },
  qna: [
    {
