    ...
    <Wrapper>
      <div className="md:flex justify-around items-center gap-10 mt-24">
        <div className="text-center md:w-[55%] pb-16">
          <h2 className="text-3xl mb-16">{t("career_page_tag_line_impacting")}</h2>

          <span className="text-4xl font-semibold">
            {t("career_page_why_work_title")}
          </span>

          <p className="text-sm mt-5 mb-10">{t("career_page_why_work_title_txt_1")}</p>
        ...
        <div className="h-[250px] md:h-[350px] lg:h-[450px]">
          <Image
            ...
            alt="african-businesswoman-smiling"></Image>
        </div>
      </div>
    </Wrapper>
  );
