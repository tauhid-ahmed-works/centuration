...
import { motion, AnimatePresence, PanInfo } from "motion/react"; // Changed from motion/react to framer-motion
...
export function Carousel({
  ...
  }, [activeIndex, paused, data.length, duration]);
...
function Dots({
  ...
  activeIndex: number;
  handleSlideClick: ({}: Record<string, number | string>) => void;
  data: Record<string, string>[];
}) {
