    ...
    <div className="p-24 max-w-screen-xl mx-auto">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          ...
          this Agreement) refers to Group Centurions, Africa.
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <strong>Website</strong> refers to Centurions, accessible from{" "}
          <a
      ...
      <h1 className="text-2xl font-semibold mt-8 mb-2">Acknowledgment</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl font-semibold mt-8 mb-2">Termination</h1>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        USD if You haven&apost;t purchased anything through the Service.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        each party&apost;s liability will be limited to the greatest extent
        permitted by law.
      </p>
      ...
      <p className="mb-4">
        ...
        company&apost;s provider makes any representation or warranty of any
      ...
      <h1 className="text-2xl font-semibold mt-8 mb-2">Governing Law</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl font-semibold mt-8 mb-2">Disputes Resolution</h1>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        efforts to provide at least 30 days&apost; notice prior to any new terms
      ...
      <h1 className="text-2xl font-semibold mt-8 mb-2">Contact Us</h1>
      <p className="mb-4">
      ...
      <ul className="list-disc list-inside mb-4">
        <li className="mb-2">
          By email:{" "}
          <a
            href="mailto:support@groupcenturions.com"
            className="text-blue-600 underline"
          >
            support@groupcenturions.com
          </a>
        </li>
      </ul>
    </div>
