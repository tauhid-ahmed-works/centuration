...
import { ArrowLong, Icons } from '@/components/icons'
            ...
            <div>
                ...
                <div className='lg:w-[45%]'>
                  ...
                  <div className="space-y-2">
                    <ul className="pt-8 pb-10 space-y-1">
                      ...
                      <li className='flex gap-2'>
                        <Icons.ArrowRight className="size-5 text-brand-500 mt-1 shrink-0" />
                        <span>Visually appealing integration into the building landscape</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="max-w-[80ch] space-y-2 text-sm font-normal">
                <ul className="text-left pt-8 pb-10 md:text-lg text-base font-normal">
                  <li className='flex gap-2'>
                    <Icons.ArrowRight className="size-5 text-brand-500 mt-1 shrink-0" />
                    <span>Take details till <span className='font-bold'>INFECTION PREVENTION:</span> SAFE PATIENT CARE GUARANTEE</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div>
          {params.slug === 'logistics' && (
            <div>
              ...
              <div className="max-w-[80ch] space-y-2 text-sm pb-5">
                <p>
                  The biggest challenge for manufacturing is to tackle logistics and distribution costs, as products will have to be moved to newer markets from production centers.
                  Apart from ramping up production capabilities across Africa by adding new greenfield projects, clinker grinding plants, and import terminals, we accord top priority to scientific logistics. Our Fleet is a fast and very reliable service provider to thousands of customers nationwide.
                  Our finished products are delivered to our markets nationwide. With a professional team that has a minimum of 15 years of industry experience, our goal is to be the best by helping our customers achieve their delivery schedules and timelines.
                </p>
              </div>
            </div>
          )}
