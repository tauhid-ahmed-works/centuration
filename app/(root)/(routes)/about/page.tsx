    ...
    <>
      <div className="h-screen text-white relative flex items-center">
        ...
        <Wrapper className="relative text-white font-semibold z-10">
          <div className="max-w-[65ch] rounded">
            ...
            <h2 className="text-4.5xl mt-2 leading-none">Premier Service Provider</h2>
            <p className="text-md leading-tight mt-4">
              Providing Your Basic Needs With our transformational projects and businesses
              across food, shelter and construction, Centurion Group continues to grow its
              vision of becoming the leading provider of essential services and needs in
              Africa.
            </p>
          </div>
        </Wrapper>
        ...
        <Wrapper>
          <div className="text-center">
            ...
            <p className="mt-4 px-6 text-left lg:text-center">
              Centurion Group continues to grow its focus of becoming the leading provider
              of essential needs in Services, Technologies, Food and Shelter in
              Sub-Saharan Africa. Our vision is to be a world-class enterprise that is
              passionate about the quality of life of the general populace. Our mission is
              to touch the lives of people by providing their basic needs. We continue to
              sustain and improve on our market leadership in Technologies and medical
        ...
        <Wrapper>
          <div className="bg-transparent ml-auto max-w-[60ch] p-10 relative z-10 rounded backdrop-blur-3xl mb-20 md:mb-0">
            <div className="text-white w-full relative">
              <h2 className="text-2xl md:text-3xl lg:text-4xl">CEO Biography</h2>
              <div className="mt-6">
                <p className="text-sm">
                  Mr Bandeira is the CEO of Centurion Group, leading the organization with
                  a vision for growth and innovation. With years of experience in the
                  industry, He has successfully driven strategic initiatives, ensuring
                  sustainable development and market leadership. Under his leadership,
                  Centurion Group has achieved significant milestones and continues to
                  pioneer new advancements.
                </p>
      ...
      <section className="py-20 md:py-32 bg-pattern-2 my-20 text-white">
        <Wrapper className="space-y-4">
          ...
          <p className="max-w-[80ch]">
            We are a company that is at the forefront of technology, becoming a strategic
            ally for your company or business, providing you with the best solutions and
            services that ensure your productivity, competitiveness, permanence and
            excellent service for your clients.
          </p>
      ...
      <section className="my-20">
        <div className="text-center">
          ...
          <p className="mt-4 px-6">
            Our values are the foundation of our company and define who we are and how we
            work.
          </p>
        </div>
