        ...
        <Wrapper>
          <div className="text-center">
            ...
            <p className="mt-4 px-6 text-left lg:text-center">
              ...
              life of the general populace. Our mission is to touch the
              lives of people by providing their basic needs. We continue to
              sustain and improve on our market leadership in Technologies
              and medical services, Commodities, Self-service launderettes.
            </p>
          </div>
        </Wrapper>
      </section>
      ...
      <section className="my-20">
        ...
        <Wrapper className="mt-14 space-y-10">
          {aboutCards.map((card, index) => (
            <div
              key={card.title}
              className={`flex flex-col gap-10 items-center ${index % 2 === 1 ? "md:flex-row-reverse" : "md:flex-row"
                }`}
            >
